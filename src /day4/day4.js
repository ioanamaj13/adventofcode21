...
var checkLines = function (tickets) {
    ...
    return { fullLine: fullLine, lineSum: lineSum, ticketNumbers: ticketNumbers, ticketIndex: ti };
};
...
var rawInput = (0, readInputString_1.readLineByLine)("../inputs/day4.txt").then(function (res) {
    ...
    // let lastWinner = tickets; 
    // console.log(lastWinner); 
    getFalseSum(tickets[getWinningTicket().index]);
    // console.log('falseSum', getFalseSum(tickets[getWinningTicket().index]));
    // console.log('last number', getWinningTicket().bingoNumberValue);
    // console.log('winningScore', getFalseSum(tickets[getWinningTicket().index]) * getWinningTicket().bingoNumberValue);
    // console.log('asdasdaeawe', 42 * getFalseSum(tickets[getWinningTicket().index]));
